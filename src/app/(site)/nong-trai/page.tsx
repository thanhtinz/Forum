...
import { ANH_FARM, GIA_MOI_O, O_DAT_BAN_DAU, O_DAT_TOI_DA, TUOI_RUT_NGAN } from '@/lib/farm-const';
...
export const metadata: Metadata = {
  title: 'Nông trại',
  description: 'Xới đất, gieo hạt, tưới nước, bón phân rồi thu hoạch giao đơn cho khách — nông trại pixel của diễn đàn.',
};
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <GopTrenDienThoai tieuDe="Luật chơi" className="card mt-4 px-4 py-3 text-sm text-ink-600 dark:text-ink-300">
        <ul className="grid list-inside list-disc gap-x-6 gap-y-1 marker:text-brand-400 sm:grid-cols-2">
          <li>Một vụ đi đúng năm việc: xới đất → gieo hạt → tưới nước → bón phân → thu hoạch.</li>
          ...
          <li>Năm loại phân, loại càng đắt bồi càng nhiều quả lúc thu.</li>
          <li>Thu hoạch vào kho, rồi giao cho khách ở bảng đơn hàng lấy điểm.</li>
          <li>Cây khế hái mỗi giờ một lần, được mấy quả khế, không mất gì.</li>
        </ul>
      </GopTrenDienThoai>
    </div>
  );
