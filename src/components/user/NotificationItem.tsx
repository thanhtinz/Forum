...
import { MessageSquare, ShoppingBag, Coins, Heart, UserPlus, Award, Bell, BookOpen } from 'lucide-react';
...
const ICONS: Record<string, React.ReactNode> = {
  ...
  MEDAL: <Award size={16} />, DONATE: <Coins size={16} />, GUESTBOOK: <BookOpen size={16} />,
  SYSTEM: <Bell size={16} />,
};
