  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5 p-4 sm:p-6">
      ...
      <div className="flex items-center gap-2">
        <Link href="/comic/creator" className="text-ink-400 hover:text-ink-600 dark:hover:text-ink-300">
          <ChevronLeft size={20} />
        </Link>
        ...
        <a href={`/comic/detail?slug=${series.slug}`} target="_blank"
      ...
      {activeTab === 'chapters' && (
        <Card>
          <div className="mb-3 flex items-center justify-between">
            ...
            <Link href={`/comic/creator/chapter/new?mediaId=${id}`}>
              ...
              {series.chapterList.map((ch) => {
                ...
                return (
                  <div key={ch.id} className="flex items-center gap-3 py-2.5">
                    ...
                    <Link href={`/comic/creator/chapter/new?chapterId=${ch.id}&mediaId=${id}`}>
