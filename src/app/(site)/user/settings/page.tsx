...
export default async function SettingsPage() {
  ...
  const user = await db.user.findUnique({
    ...
    select: { name: true, username: true, bio: true, signature: true, mood: true, image: true, cover: true, email: true, passwordHash: true, notifyOff: true },
  });
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="space-y-4">
        <ProfileSettingsForm initial={{
          name: user.name, username: user.username, bio: user.bio, signature: user.signature, mood: user.mood,
