 ...
 */
export const TOGGLEABLE_TYPES = ['COMMENT', 'REPLY', 'MENTION', 'LIKE', 'FOLLOW', 'MEDAL', 'GUESTBOOK', 'FRIEND', 'KARMA', 'CLUB'] as const;
...
export const NOTIFY_LABELS: Record<ToggleableType, { label: string; hint: string }> = {
  ...
  CLUB: { label: 'Câu lạc bộ', hint: 'Khi có người xin vào câu lạc bộ của bạn, hoặc đơn xin vào của bạn được duyệt' },
};
