...
export const metadata: Metadata = {
  title: 'Bài viết',
  description: 'Blog, hướng dẫn và nội dung trả phí trên Nova.',
};
      ...
      <section className="grid gap-4 lg:grid-cols-[1fr_320px]">
        ...
        >
          ...
          <div className="relative">
            <h1 className="text-2xl font-black drop-shadow sm:text-3xl">{hero?.title ?? 'Bài viết trên Nova'}</h1>
            <p className="mt-1 max-w-lg text-white/90 drop-shadow">{hero?.subtitle ?? 'Hướng dẫn, chia sẻ và nội dung trả phí.'}</p>
          </div>
        </Link>
