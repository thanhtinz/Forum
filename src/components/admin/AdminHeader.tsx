    ...
    <header className="sticky top-0 z-40 border-b border-ink-800 bg-ink-950 text-white">
      <div className="mx-auto flex h-14 max-w-[1400px] items-center gap-3 px-4">
        <Link href="/admin" className="flex items-center gap-2">
          <span className="grid size-8 place-items-center rounded-lg bg-brand-500 text-white"><ShieldCheck size={18} /></span>
          <span className="text-base font-black tracking-tight">Nova <span className="text-brand-400">Quản trị</span></span>
        </Link>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 rounded-full bg-ink-800/70 py-1 pl-1 pr-3">
