...
const CATS: { key: string; label: string; items: Item[] }[] = [
  { key: 'crypto', label: 'Tiền điện tử', items: [
    ...
    { symbol: 'ADA-USD', name: 'Cardano' }, { symbol: 'TON11419-USD', name: 'Toncoin' },
  ] },
  ...
  { key: 'vn', label: 'Cổ phiếu VN', items: [
    { symbol: 'VIC.VN', name: 'Vingroup' }, { symbol: 'VNM.VN', name: 'Vinamilk' }, { symbol: 'FPT.VN', name: 'FPT' },
    { symbol: 'HPG.VN', name: 'Hòa Phát' }, { symbol: 'VCB.VN', name: 'Vietcombank' }, { symbol: 'MWG.VN', name: 'Thế Giới Di Động' },
  ] },
  { key: 'index', label: 'Chỉ số', items: [
    { symbol: '^GSPC', name: 'S&P 500' }, { symbol: '^IXIC', name: 'Nasdaq' }, { symbol: '^DJI', name: 'Dow Jones' },
    { symbol: '^VNINDEX', name: 'VN-Index' }, { symbol: '^N225', name: 'Nikkei 225' }, { symbol: '^FTSE', name: 'FTSE 100' },
  ] },
  { key: 'metal', label: 'Kim loại', items: [
    { symbol: 'GC=F', name: 'Vàng' }, { symbol: 'SI=F', name: 'Bạc' }, { symbol: 'PL=F', name: 'Bạch kim' }, { symbol: 'HG=F', name: 'Đồng' },
  ] },
  ...
  { key: 'forex', label: 'Ngoại tệ', items: [
    { symbol: 'USDVND=X', name: 'USD/VND' }, { symbol: 'EURUSD=X', name: 'EUR/USD' }, { symbol: 'USDJPY=X', name: 'USD/JPY' },
    { symbol: 'GBPUSD=X', name: 'GBP/USD' }, { symbol: 'DX-Y.NYB', name: 'Chỉ số USD' },
  ] },
  { key: 'etf', label: 'ETF / Trái phiếu', items: [
    { symbol: 'SPY', name: 'SPDR S&P 500' }, { symbol: 'QQQ', name: 'Invesco QQQ' }, { symbol: 'GLD', name: 'Vàng ETF' },
    { symbol: '^TNX', name: 'Lợi suất TP Mỹ 10Y' },
  ] },
];
