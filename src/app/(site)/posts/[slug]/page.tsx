...
import { Eye, MessageSquare, Calendar, FolderOpen, Lock } from 'lucide-react';
    ...
    <article>
      ...
      <div className="card mt-6 p-5 sm:p-6">
        <PostTabs
          ...
          comments={<Comments postId={post.id} slug={post.slug} loggedIn={!!accessUser} />}
