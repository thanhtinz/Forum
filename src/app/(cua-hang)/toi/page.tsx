...
import { ArrowUpCircle, Bell, ChevronRight, Inbox, Library, LogIn, LogOut, Settings, Shield } from 'lucide-react';
  ...
  return (
    <div className="cot space-y-5">
      ...
      <ul className="the divide-y divide-vien">
        ...
        <Muc duongDan="/toi/theo-doi" icon={<Bell size={18} />} ten="Chủ đề đang theo dõi" />
