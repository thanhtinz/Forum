...
export function FloatingDock() {
  ...
  return (
    <>
      ...
      {open && (
        <div style={drag.panelStyle(340, 480)} className="fixed z-40 w-[340px] max-w-[92vw] rounded-2xl border border-ink-200 bg-white shadow-2xl dark:border-ink-700 dark:bg-ink-900">
