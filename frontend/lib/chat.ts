...
export interface ChatUser { id: string; username: string; displayName?: string | null; avatar?: string | null; role?: string | null; verifiedBadge?: boolean | null; nameEffectCss?: string | null; chatBubbleUrl?: string | null; chatBubbleColor?: string | null }
